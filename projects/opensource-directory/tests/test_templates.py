...
class TestCategoryTemplate:
    ...
    def test_renders_category(self, real_env, sample_items):
        ...
        all_cats = [{"name": "Communication", "slug": "communication", "count": 2}]
        html = tpl.render(
            ...
            page_title="Communication Open Source Alternatives",
            page_description="Browse communication open source alternatives",
            page_url="https://test.com/category/communication.html",
            canonical_url="https://test.com/category/communication.html",
        )
        assert "Communication" in html
        assert "Mattermost" in html
