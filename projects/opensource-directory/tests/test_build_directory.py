...
class TestBuildItemPages:
    ...
    def test_item_page_contains_meta(self, tmp_path, templates_dir, sample_items):
        ...
        page = dist_dir / "item" / "mattermost-alternative-to-slack.html"
        content = page.read_text(encoding="utf-8")
    ...
    def test_item_page_has_related_items(self, tmp_path, templates_dir, sample_items):
        ...
        # Plausible and PostHog are both Analytics
        page = dist_dir / "item" / "plausible-analytics-alternative-to-google-analytics.html"
        content = page.read_text(encoding="utf-8")
...
class TestBuildCategoryPages:
    ...
    def test_generates_category_files(self, tmp_path, templates_dir, sample_items):
        ...
        assert (cat_dir / "communication.html").exists()
        assert (cat_dir / "analytics.html").exists()
    ...
    def test_category_page_contains_items(self, tmp_path, templates_dir, sample_items):
        ...
        content = (dist_dir / "category" / "analytics.html").read_text(encoding="utf-8")
        assert "Plausible Analytics" in content
        assert "PostHog" in content
