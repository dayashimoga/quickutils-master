...
1. **Link your GitHub Repository** to the Cloudflare dashboard (`H:\boring\projects\opensource-directory`).
...
2. Enter your desired domain name representing your open source sub-brand (e.g. `opensource.quickutils.top`).
