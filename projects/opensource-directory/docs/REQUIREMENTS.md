...
## Product Identity
**Target Niche:** Open-Source Alternatives
...
1. **Static Rendering Pipeline**
   - Must consume JSON arrays containing properties (`title`, `url`, `description`, `alternative_to`, `github_repo`, `license`).
...
- Specific usage of `alternative_to, github_repo, license` to define taxonomy.
