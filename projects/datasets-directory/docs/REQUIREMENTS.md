...
## Product Identity
**Target Niche:** Public Datasets Directory
...
1. **Static Rendering Pipeline**
   - Must consume JSON arrays containing properties (`title`, `url`, `description`, `format`, `size`, `license`).
...
- Specific usage of `format, size, license` to define taxonomy.
