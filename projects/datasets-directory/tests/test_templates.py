...
class TestCategoryTemplate:
    ...
    def test_renders_category(self, real_env, sample_items):
        ...
        html = tpl.render(
            ...
            page_title="Free Transportation Public Datasets | Test Site",
            page_description="Browse 2 free public datasets for transportation. Find the best data for your next project.",
