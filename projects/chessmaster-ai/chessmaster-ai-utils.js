...
export const REPERTOIRE_DB = {
  white: [
    ...
    { trigger:'1.e4', opponentResponse:'e5', repertoireName:'Italian Game', moves:['e4','e5','Nf3','Nc6','Bc4'], plans:'Develop bishop to active c4 square, attack f7 weakness, castle early.', traps:'Blackburne Shilling Gambit: beware Nxe5 tricks.', goals:'Fast kingside attack, control center with c3-d4 breaks.' },
    { trigger:'1.d4', opponentResponse:'d5', repertoireName:'Queen\'s Gambit', moves:['d4','d5','c4'], plans:'Offer c-pawn to gain center control, pressure d5, attack queenside.', traps:'Queen\'s Gambit Declined: solid defenses, avoid trapping light-squared bishop.', goals:'Force black to surrender center or defend passively.' }
  ],
  black: [
    { trigger:'Against e4', opponentResponse:'1.e4', repertoireName:'Caro-Kann Defense', moves:['e4','c6','d4','d5'], plans:'Solid pawn wall, activate light-squared bishop to f5, counter-attack d4.', traps:'Secure f7 before pushing knight outposts.', goals:'Dismantle white\'s center from a solid base.' },
    { trigger:'Against d4', opponentResponse:'1.d4', repertoireName:'Slav Defense', moves:['d4','d5','c4','c6'], plans:'Support d5 with c6, develop bishop to f5/g4, solid development.', traps:'Retain d5 focal point, avoid opening files prematurely.', goals:'Neutralize Queen\'s pawn aggression without locking in bishop.' },
    { trigger:'Against d4', opponentResponse:'1.d4', repertoireName:'King\'s Indian Defense', moves:['d4','Nf6','c4','g6','Nc3','Bg7'], plans:'Fianchetto bishop, build up kingside attack, play ...e5 break.', traps:'Don\'t allow white to steamroll queenside before your kingside attack.', goals:'Dynamic counterattack on the kingside after initial concessions.' },
    { trigger:'Against e4', opponentResponse:'1.e4', repertoireName:'Sicilian Najdorf', moves:['e4','c5','Nf3','d6','d4','cxd4','Nxd4','a6'], plans:'Flexible pawn structure, prepare ...e5 or ...b5, counterattack.', traps:'Be careful of early Bg5 pins and Bc4 attacking f7.', goals:'Create imbalanced position where Black has dynamic chances.' },
    { trigger:'Against e4', opponentResponse:'1.e4', repertoireName:'Scandinavian Defense', moves:['e4','d5','exd5','Qxd5'], plans:'Immediate center challenge, counter-attack white d-pawn, active queen.', traps:'Avoid early Nc3 queen chases without safety.', goals:'Open lines and free pieces from move one.' },
    { trigger:'Against d4', opponentResponse:'1.d4', repertoireName:'Grunfeld Defense', moves:['d4','Nf6','c4','g6','Nc3','d5'], plans:'Challenge white center with ...d5, fianchetto king bishop, counterattack c4.', traps:'Beware early exchange on d5 opening white center.', goals:'Dynamic pawn breaks against white\'s large center.' }
  ]
};
