...
class TestOptimizeImages:
    ...
    def test_skips_if_no_images_dir(self, tmp_path):
        with patch("scripts.build_directory.DIST_DIR", tmp_path / "dist"):
            # Should return early
            optimize_images()
    ...
    def test_handles_optimization_error(self, tmp_path):
        ...
        img_dir = dist_dir / "images"
        img_dir.mkdir(parents=True)
        (img_dir / "broken.jpg").write_text("not an image", encoding="utf-8")
