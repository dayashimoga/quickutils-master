...
1. **Link your GitHub Repository** to the Cloudflare dashboard (`H:\boring\projects\prompts-directory`).
...
2. Enter your desired domain name representing your Web Setup Tools sub-brand (e.g. `prompts.quickutils.top`).
