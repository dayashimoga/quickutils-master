# Technical Architecture - Cheatsheets

## System Overview
Cheatsheets is part of the QuickUtils network, a programmatic SEO static site ecosystem. It leverages a fully automated pipeline to fetch data, generate optimized static pages, and deploy at zero cost.
